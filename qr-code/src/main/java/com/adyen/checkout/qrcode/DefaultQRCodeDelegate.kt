    ...
    override fun downloadQRImage() {
        ...
        coroutineScope.launch {
            fileDownloader.download(
                ...
                onSuccess = { eventChannel.trySend(QrCodeUIEvent.QrImageDownloadedResult.Success) },
                onFailure = { e -> eventChannel.trySend(QrCodeUIEvent.QrImageDownloadedResult.Failure(e)) }
            )
        }
    }
